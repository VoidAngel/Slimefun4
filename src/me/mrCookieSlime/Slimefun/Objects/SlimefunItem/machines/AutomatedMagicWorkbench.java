...
public abstract class AutomatedMagicWorkbench extends SlimefunItem {
	...
	public AutomatedMagicWorkbench(Category category, ItemStack item, String name, RecipeType recipeType, ItemStack[] recipe) {
		super(category, item, name, recipeType, recipe);
		
		new BlockMenuPreset(name, "&dAutomated Magic Workbench") {
	...
	protected void constructMenu(BlockMenuPreset preset) {
		...
		preset.addItem(2, new CustomItem(new MaterialData(Material.BOOKSHELF), "&eRecipe", "", "&bPut in the Recipe you want to craft", "&4Magic Workbench Recipes ONLY"),
		new MenuClickHandler() {
	...
	public void register(boolean slimefun) {
		addItemHandler(new BlockTicker() {
			...
			public void tick(Block b, SlimefunItem sf, Config data) {
				AutomatedMagicWorkbench.this.tick(b);
			}
