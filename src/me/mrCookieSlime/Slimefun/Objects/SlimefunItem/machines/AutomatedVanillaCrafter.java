...
public abstract class AutomatedVanillaCrafter extends SlimefunItem {
	...
	public AutomatedVanillaCrafter(Category category, ItemStack item, String name, RecipeType recipeType, ItemStack[] recipe) {
		super(category, item, name, recipeType, recipe);
		
		new BlockMenuPreset(name, "&6Automated Vanilla Crafter") {
	...
	protected void constructMenu(BlockMenuPreset preset) {
		...
		preset.addItem(2, new CustomItem(new MaterialData(Material.WORKBENCH), "&eRecipe", "", "&bPut in the Recipe you want to craft", "&4Vanilla Shaped Crafting Table Recipes ONLY"),
		new MenuClickHandler() {
	...
	public void register(boolean slimefun) {
		addItemHandler(new BlockTicker() {
			...
			public void tick(Block b, SlimefunItem sf, Config data) {
				AutomatedVanillaCrafter.this.tick(b);
			}
	...
	protected void tick(Block b) {
		...
		if (input.equals("NULL </slot> NULL </slot> NULL </slot> NULL </slot> NULL </slot> NULL </slot> NULL </slot> NULL </slot> NULL"))
			return;
